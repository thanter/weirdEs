...
running as well. For example, the rendering engine or HTTP requests etc.
...
how to handle each event. Based on if there exists a dedicated handler for this event.
